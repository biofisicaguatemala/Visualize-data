...
ad = 50 #Characteristic time constant for long-range EPSPs (1/sec)
b = 50 #Characteristic time constasnt for IPSPs (1/sec)
p = 4.8 #Basal input to pyramidal population 
sigma = 1 * np.sqrt(dt) #Input standard deviation
...
#As a multiple of C
alpha = 2  #Long-range pyramidal-pyramidal coupling
